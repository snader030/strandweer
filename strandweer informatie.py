...
appid = "8f3a5f240b1131a25d95fbb2c6e30275"
url = "https://pro.openweathermap.org/data/2.5/forecast/climate?q=%s&appid=%s&units=metric" % (
    q,
    appid,
)
...
temp0 = data["list"][0]["feels_like"]["day"]
temp1 = data["list"][1]["feels_like"]["day"]
temp2 = data["list"][2]["feels_like"]["day"]
temp3 = data["list"][3]["feels_like"]["day"]
temp4 = data["list"][4]["feels_like"]["day"]
...
# Print onderstaande
print(
    ("De gevoelstemperaturen verwacht om 12u voor de komende vijf dagen zijn:"),
